                ...
                <div className='row mt-5'>
                    <div className='col-12 col-md-8 mx-auto mt-5'>
                       ...
                       <h1>Request Data Deletion</h1>
                        ...
                        <p >Thank You for using TheInk! We Understand that sometimes our users would like to
                            delete existing data from our
                            database.We Would be more than happy to work you in removing
                            the required data from our database.Please provide your information below
                            and we will be in touch as soon as possible to confirm your request</p>
                            <form onSubmit={SubmitRequsetData}>
                            <label><strong>Your Name</strong></label>
                            <input className="form-control" /><br/>
                            <label><strong>Registered Mobile Number</strong></label>
                            <input className="form-control" /><br/>
                            <label><strong>Please provide a description of the data you would like deleted</strong></label>
                            <input className="form-control" />
                            <button className="btn btn-danger mt-3 col-12 mb-5" type="submit">Request Data</button>
                        </form>
                    </div>
