                                                                    ...
                                                                    <article
                                                                        ...
                                                                        <div className="post_boxes">
                                                                            ...
                                                                            <div className="post-content media-body">
                                                                                    ...
                                                                                    <div class="entry-meta meta-0 font-small mb-20">
                                                                                        <a to="#" tabindex="0">
                                                                                            <span class="post-cat bg-success font-small color-white">
                                                                                                {tranding_post?.tags}</span></a>
                                                                                    </div>
                                                                                    <span class="post-in"><i class="ti-user"
                                                                                        aria-hidden="true"></i> Admin</span>
                                                                                ...
                                                                                <p className="mb-0 mt-2">{tranding_post?.short_decription}</p>
                                                                            </div>
                                                                        </div>
                                                                    </article>
                                                                </Link>
                                        ...
                                        <div className="sidebar-right">
                                            ...
                                            <div className="latestnews_update">
                                                <ul class="nav nav-pills" id="pills-tab" role="tablist">
                                                    <li class="nav-item">
                                                        <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">Recent</a>
                                                    </li>
                                                    <li class="nav-item">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false">Common</a>
                                                    </li>
                                                </ul>
